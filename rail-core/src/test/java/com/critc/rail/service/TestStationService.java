...
public class TestStationService {
    ...
    public void testStationsAdjoin() {
        ...
        boolean result = stationService.adjoin(links, stationA, stationB);
        Assert.assertTrue(result);
        System.out.println(DateUtil.getSystemTime());

        //车站A、D邻接
        System.out.println(DateUtil.getSystemTime());
        result = stationService.adjoin(links, stationA, stationD);
        Assert.assertTrue(result);
        System.out.println(DateUtil.getSystemTime());

        //车站A、C不邻接
        System.out.println(DateUtil.getSystemTime());
        result = stationService.adjoin(links, stationA, stationC);
