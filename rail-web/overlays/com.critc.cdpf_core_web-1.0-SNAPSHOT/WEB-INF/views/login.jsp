        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    ...
                    <h1 class="col-md-4"><b>CRI</b><b style="color: #4BA5F8">TC</b></h1>
                    <h3 class="col-md-8" style="color: #a0a9b4;margin-top:7%;"> ——弘远技术研发中心</h3>
                    </div>
                    <div class="login-content">
                        <h1>统一开发框架</h1>
                        <p> 研发中心制定的技术架构采用业界成熟稳定、开源可靠的技术解决方案，在权限制定、日志处理、异常处理、UI设计等方面，依据《应用软件开发技术规范V0.2.docx》，开发的自主软件研发平台。 </p>
