...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        var cookie_chk = jQuery.jCookie('critc_chk');
        if (cookie_chk != '' && cookie_chk != null && cookie_chk == '1') {
            $('#chk').prop("checked", true);
            $('#username').val(jQuery.jCookie('critc_username'));
        }
    });

    function checkLogin() {
        if ($('#chk').is(':checked')) {
            jQuery.jCookie('critc_chk', '1', 30);
            jQuery.jCookie('critc_username', $('#username').val(), 30);
        } else {
            jQuery.jCookie('critc_chk', '0', 30);
        }
